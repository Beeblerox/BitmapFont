package pxBitmapFont
{
	...
	public class PxBitmapFont 
	{
		 ...
		 */
		public function render(pBitmapData:BitmapData, pFontData:Array, pText:String, pColor:int, pOffsetX:int, pOffsetY:int, pLetterSpacing:int, pAngle:Number = 0):void
		{
			_point.x = pOffsetX;
			_point.y = pOffsetY;
			var glyph:BitmapData;
